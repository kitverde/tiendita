...
<head>
	...
	<link rel="stylesheet" type="text/css" href="styleindex1.css">
	<title>Inicio</title>
</head>
<body>
	<div id="login"><form method="post" action="validar.php"><table><tr><td><input type="text" name="usuario" placeholder="Usuario"></td><td><input type="password" name="password" placeholder="contraseña"></td><td><input type="submit" name="ingresar" value="ingresar"></td></tr></table></form></div>
<header>
	
	<h1><img src="img/logo.png">"Kit verde"</h1>
</header>
<nav id="nav">
	<ul>
...
<main>
	<img src="img/fondito.jpg">
	<h2>Descripcion del proyecto</h2>
	<article>
		El proyecto se basa en el desarrollo e implementación de un invernadero automatizado, el cual se puede controlar via remota a traves de una aplicación movil con la cual podras modificar varios de los 
	</article></main>
<footer >
